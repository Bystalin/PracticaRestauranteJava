...
import test.restaurante.util.JsfUtil;
import test.restaurante.util.PaginationHelper;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private test.restaurante.CategoriaFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        System.out.println (JsfUtil.getSelectItems(ejbFacade.findAll(), true)); 
